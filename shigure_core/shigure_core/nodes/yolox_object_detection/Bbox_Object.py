...
class BboxObject:
    ...
    def __init__(self,  bounding_box:BoundingBox, size:int, mask_img:np.ndarray, found_at:Timestamp,class_id:str,object_id:str):
    ...
    def is_match(self, other):
    	...
    	if (self._class_id==other._class_id)and(bbox_x < 20) and (bbox_y < 20)and(bbox_width < 20): #& bbox_width < 30 & bbox_height < 30:
